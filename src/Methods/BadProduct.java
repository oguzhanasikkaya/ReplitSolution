...
To declare if the products shipment was good or bad it also gets a limited number of how many products can be broken
        for it to be considered a good shipment.
...
limit(int) - represents the max amount of broken items for this shipment to be considered good
 (and the method returns true) for example : products [1,1,1,1,0] limit:3, there is only 1 broken product
 and its less then the limit (3) return true.
 */

/*
hint:
create a counter, loop the products,
increment it for each 0 you find. finally compare counter to limit and return true or false
 */
